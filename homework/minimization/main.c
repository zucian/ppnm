...
int main(int argc, char *argv[])
{
    ...
    minimumX = 1; //x-value of minimum for Rosenbrock
    minimumY = 1; //y-value of minimum for Rosenbrock
    initialXValue = minimumX - 1;
    initialYValue = minimumY - 1;
    ...
    printf("Actual minima is parabola");
    ...
    minimumX = 3;
    minimumY = 2;
    initialXValue = minimumX - 0.4;
    initialYValue = minimumY - 0.3;
